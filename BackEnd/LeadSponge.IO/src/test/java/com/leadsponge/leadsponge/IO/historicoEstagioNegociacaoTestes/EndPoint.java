package com.leadsponge.leadsponge.IO.historicoEstagioNegociacaoTestes;
...
@DisplayName("Testando token do EndPoint Historico Estagio Negociação")
public class EndPoint {
	...
	@MockBean
	private HistEstagioNegociacao service;

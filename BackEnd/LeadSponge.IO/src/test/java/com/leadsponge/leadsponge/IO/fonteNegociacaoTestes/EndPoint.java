...
public class EndPoint {
	...
	public void listar() throws Exception {
		...
		mockMvc.perform(get("/fontes").header("Authorization", "Bearer " + Util.getAccessToken("admin", "123321", mockMvc)).accept(MediaType.APPLICATION_JSON)).andExpect(status().isOk()).andDo(print());
		verify(service, times(1)).filtrar(fonteNegociacaoFilter, pageable);
	}
	...
	public void listarNome() throws Exception {
		...
		Pageable pageable = PageRequest.of(0, 10);
		when(service.filtrar(fonteNegociacaoFilter, pageable)).thenReturn(page);
		mockMvc.perform(get("/fontes?nome=nome").header("Authorization", "Bearer " + Util.getAccessToken("admin", "123321", mockMvc)).accept(MediaType.APPLICATION_JSON)).andExpect(status().isOk()).andDo(print());
		verify(service, times(1)).filtrar(fonteNegociacaoFilter, pageable);
	}
	...
	public void buscar() throws Exception {
		...
		mockMvc.perform(get("/fontes/{id}", 1L).header("Authorization", "Bearer " + Util.getAccessToken("admin", "123321", mockMvc)).accept(MediaType.APPLICATION_JSON)).andExpect(content().contentType(contentType))
	...
	public void deletar() throws Exception {
		mockMvc.perform(delete("/fontes/{id}", 1L).header("Authorization", "Bearer " + Util.getAccessToken("admin", "123321", mockMvc)).accept(MediaType.APPLICATION_JSON)).andExpect(status().isOk()).andDo(print());
	...
	public void criar() throws Exception {
		...
		mockMvc.perform(post("/fontes").header("Authorization", "Bearer " + Util.getAccessToken("admin", "123321", mockMvc)).accept(MediaType.APPLICATION_JSON).content(jsonString).contentType(MediaType.APPLICATION_JSON))
	...
	public void atualizar() throws Exception {
		...
		ObjectMapper mapper = new ObjectMapper();
		String jsonString = mapper.writeValueAsString(fonteNegociacao);
		mockMvc.perform(put("/fontes/{id}", 1L).header("Authorization", "Bearer " + Util.getAccessToken("admin", "123321", mockMvc)).accept(MediaType.APPLICATION_JSON).content(jsonString).contentType(MediaType.APPLICATION_JSON))
				.andExpect(content().contentType(contentType)).andExpect(status().isCreated()).andDo(print()).andExpect(jsonPath("$.nome").value("nome")).andExpect(jsonPath("$.cargo").value("cargo"));
		verify(service, times(1)).atualizar(1L, fonteNegociacao);
	}
	...
	public void permissaoListar() throws Exception {
		...
		Pageable pageable = PageRequest.of(0, 10);
		when(service.filtrar(fonteNegociacaoFilter, pageable)).thenReturn(page);
		mockMvc.perform(get("/fontes").header("Authorization", "Bearer " + Util.getAccessToken("user", "123321", mockMvc)).accept(MediaType.APPLICATION_JSON)).andExpect(status().isForbidden()).andDo(print());
		verify(service, times(0)).filtrar(fonteNegociacaoFilter, pageable);
	}
	...
	public void permissaoListarsNome() throws Exception {
		...
		Pageable pageable = PageRequest.of(0, 10);
		when(service.filtrar(fonteNegociacaoFilter, pageable)).thenReturn(page);
		mockMvc.perform(get("/fontes?nome=nome").header("Authorization", "Bearer " + Util.getAccessToken("user", "123321", mockMvc)).accept(MediaType.APPLICATION_JSON)).andExpect(status().isForbidden()).andDo(print());
		verify(service, times(0)).filtrar(fonteNegociacaoFilter, pageable);
	}
	...
	public void permissaoBuscar() throws Exception {
		FonteNegociacao fonteNegociacao = new FonteNegociacao(1L, "nome", null);
		when(service.detalhar(1L)).thenReturn(fonteNegociacao);
		mockMvc.perform(get("/fontes/{id}", 1L).header("Authorization", "Bearer " + Util.getAccessToken("user", "123321", mockMvc)).accept(MediaType.APPLICATION_JSON)).andExpect(content().contentType(contentType))
	...
	public void permissaoDeletar() throws Exception {
		mockMvc.perform(delete("/fontes/{id}", 1L).header("Authorization", "Bearer " + Util.getAccessToken("user", "123321", mockMvc)).accept(MediaType.APPLICATION_JSON)).andExpect(status().isForbidden()).andDo(print());
	...
	public void permissaoCriar() throws Exception {
		...
		ObjectMapper mapper = new ObjectMapper();
		String jsonString = mapper.writeValueAsString(fonteNegociacao);
		mockMvc.perform(post("/fontes").header("Authorization", "Bearer " + Util.getAccessToken("user", "123321", mockMvc)).accept(MediaType.APPLICATION_JSON).content(jsonString).contentType(MediaType.APPLICATION_JSON))
	...
	public void permissaoAtualizar() throws Exception {
		...
		ObjectMapper mapper = new ObjectMapper();
		String jsonString = mapper.writeValueAsString(fonteNegociacao);
		mockMvc.perform(put("/fontes/{id}", 1L).header("Authorization", "Bearer " + Util.getAccessToken("user", "123321", mockMvc)).accept(MediaType.APPLICATION_JSON).content(jsonString).contentType(MediaType.APPLICATION_JSON))
				.andExpect(content().contentType(contentType)).andExpect(status().isForbidden()).andDo(print());
		verify(service, times(0)).atualizar(1L, fonteNegociacao);
	}
	...
	public void listamosTokenIncorreto() throws Exception {
		...
		Pageable pageable = PageRequest.of(0, 10);
		when(service.filtrar(fonteNegociacaoFilter, pageable)).thenReturn(page);
		mockMvc.perform(get("/fontes").header("Authorization", "Bearer " + Util.getAccessToken("a", "a", mockMvc)).accept(MediaType.APPLICATION_JSON)).andExpect(content().contentType(contentType)).andExpect(status().isUnauthorized())
	...
	public void buscarTokenIncorreto() throws Exception {
		FonteNegociacao fonteNegociacao = new FonteNegociacao(1L, "nome", null);
		when(service.detalhar(1L)).thenReturn(fonteNegociacao);
		mockMvc.perform(get("/fontes/{id}", 1L).header("Authorization", "Bearer " + Util.getAccessToken("a", "a", mockMvc)).accept(MediaType.APPLICATION_JSON)).andExpect(content().contentType(contentType))
	...
	public void deletarTokenIncorreto() throws Exception {
		...
		mockMvc.perform(delete("/fontes/1").header("Authorization", "Bearer " + Util.getAccessToken("a", "a", mockMvc)).accept(MediaType.APPLICATION_JSON)).andExpect(content().contentType(contentType)).andExpect(status().isUnauthorized())
				.andDo(print()).andExpect(jsonPath("$.error").value("invalid_token"));
		verify(service, times(0)).deletar(1L);
	}
	...
	public void criarTokenIncorreto() throws Exception {
		...
		ObjectMapper mapper = new ObjectMapper();
		String jsonString = mapper.writeValueAsString(fonteNegociacao);
		mockMvc.perform(post("/fontes").header("Authorization", "Bearer " + Util.getAccessToken("a", "a", mockMvc)).accept(MediaType.APPLICATION_JSON).content(jsonString).contentType(MediaType.APPLICATION_JSON))
	...
	public void atualizarTokenIncorreto() throws Exception {
		...
		ObjectMapper mapper = new ObjectMapper();
		String jsonString = mapper.writeValueAsString(fonteNegociacao);
		mockMvc.perform(put("/fontes/1").header("Authorization", "Bearer " + Util.getAccessToken("a", "a", mockMvc)).accept(MediaType.APPLICATION_JSON).content(jsonString).contentType(MediaType.APPLICATION_JSON))
				.andExpect(content().contentType(contentType)).andExpect(status().isUnauthorized()).andDo(print()).andExpect(jsonPath("$.error").value("invalid_token"));
		verify(service, times(0)).atualizar(1L, fonteNegociacao);
	}
	...
	public void listamosSemToken() throws Exception {
		...
		Pageable pageable = PageRequest.of(0, 10);
		when(service.filtrar(fonteNegociacaoFilter, pageable)).thenReturn(page);
		mockMvc.perform(get("/fontes")).andExpect(content().contentType(contentType)).andExpect(status().isUnauthorized()).andDo(print()).andExpect(jsonPath("$.error").value("unauthorized"));
		verify(service, times(0)).filtrar(fonteNegociacaoFilter, pageable);
	}
	...
	public void buscarSemToken() throws Exception {
		FonteNegociacao fonteNegociacao = new FonteNegociacao(1L, "nome", null);
		when(service.detalhar(1L)).thenReturn(fonteNegociacao);
		mockMvc.perform(get("/fontes/{id}", 1L)).andExpect(content().contentType(contentType)).andExpect(status().isUnauthorized()).andDo(print()).andExpect(jsonPath("$.error").value("unauthorized"));
		verify(service, times(0)).detalhar(1L);
	}
	...
	public void deletarSemToken() throws Exception {
		when(service.deletar(1L)).thenReturn(fonteNegociacao);
		mockMvc.perform(delete("/fontes/1")).andExpect(content().contentType(contentType)).andExpect(status().isUnauthorized()).andDo(print()).andExpect(jsonPath("$.error").value("unauthorized"));
		verify(service, times(0)).deletar(1L);
	}
	...
	public void criarSemToken() throws Exception {
		...
		ObjectMapper mapper = new ObjectMapper();
		String jsonString = mapper.writeValueAsString(fonteNegociacao);
		mockMvc.perform(post("/fontes").accept(MediaType.APPLICATION_JSON).content(jsonString).contentType(MediaType.APPLICATION_JSON)).andExpect(content().contentType(contentType)).andExpect(status().isUnauthorized()).andDo(print())
	...
	public void atualizarSemToken() throws Exception {
		...
		ObjectMapper mapper = new ObjectMapper();
		String jsonString = mapper.writeValueAsString(fonteNegociacao);
		mockMvc.perform(put("/fontes/1").accept(MediaType.APPLICATION_JSON).content(jsonString).contentType(MediaType.APPLICATION_JSON)).andExpect(content().contentType(contentType)).andExpect(status().isUnauthorized()).andDo(print())
				.andExpect(jsonPath("$.error").value("unauthorized"));
		verify(service, times(0)).atualizar(1L, fonteNegociacao);
	}
	...
	public void atualizarSemInformarUmaDescricao() throws Exception {
		...
		verify(service, times(1)).atualizar(1L, fonteNegociacaoNovo);
	}

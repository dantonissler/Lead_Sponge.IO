...
public class EndPoint {
	...
	public void listar() throws Exception {
		...
		mockMvc.perform(get("/estagios").header("Authorization", "Bearer " + Util.getAccessToken("admin", "123321", mockMvc)).accept(MediaType.APPLICATION_JSON)).andExpect(status().isOk()).andDo(print());
		verify(service, times(1)).filtrar(estagioNegociacaoFilterFilter, pageable);
	}
	...
	public void listarNome() throws Exception {
		...
		Pageable pageable = PageRequest.of(0, 10);
		when(service.filtrar(estagioNegociacaoFilterFilter, pageable)).thenReturn(page);
		mockMvc.perform(get("/estagios?nome=nome").header("Authorization", "Bearer " + Util.getAccessToken("admin", "123321", mockMvc)).accept(MediaType.APPLICATION_JSON)).andExpect(status().isOk()).andDo(print());
		verify(service, times(1)).filtrar(estagioNegociacaoFilterFilter, pageable);
	}
	...
	public void listarApelido() throws Exception {
		...
		Pageable pageable = PageRequest.of(0, 10);
		when(service.filtrar(estagioNegociacaoFilterFilter, pageable)).thenReturn(page);
		mockMvc.perform(get("/estagios?apelido=apelido").header("Authorization", "Bearer " + Util.getAccessToken("admin", "123321", mockMvc)).accept(MediaType.APPLICATION_JSON)).andExpect(status().isOk()).andDo(print());
		verify(service, times(1)).filtrar(estagioNegociacaoFilterFilter, pageable);
	}
	...
	public void listarPosicao() throws Exception {
		...
		Pageable pageable = PageRequest.of(0, 10);
		when(service.filtrar(estagioNegociacaoFilterFilter, pageable)).thenReturn(page);
		mockMvc.perform(get("/estagios?posicao=1").header("Authorization", "Bearer " + Util.getAccessToken("admin", "123321", mockMvc)).accept(MediaType.APPLICATION_JSON)).andExpect(status().isOk()).andDo(print());
		verify(service, times(1)).filtrar(estagioNegociacaoFilterFilter, pageable);
	}
	...
	public void buscar() throws Exception {
		...
		mockMvc.perform(get("/estagios/{id}", 3L).header("Authorization", "Bearer " + Util.getAccessToken("admin", "123321", mockMvc)).accept(MediaType.APPLICATION_JSON)).andExpect(content().contentType(contentType))
				.andExpect(status().isOk()).andDo(print()).andExpect(jsonPath("$.nome").value("nome")).andExpect(jsonPath("$.apelido").value("apelido"));
	...
	public void deletar() throws Exception {
		mockMvc.perform(delete("/estagios/{id}", 3L).header("Authorization", "Bearer " + Util.getAccessToken("admin", "123321", mockMvc)).accept(MediaType.APPLICATION_JSON)).andExpect(status().isOk()).andDo(print());
	...
	public void criar() throws Exception {
		...
		mockMvc.perform(post("/estagios").header("Authorization", "Bearer " + Util.getAccessToken("admin", "123321", mockMvc)).accept(MediaType.APPLICATION_JSON).content(jsonString).contentType(MediaType.APPLICATION_JSON))
				.andExpect(content().contentType(contentType)).andExpect(status().isCreated()).andDo(print()).andExpect(jsonPath("$.nome").value("nome")).andExpect(jsonPath("$.apelido").value("apelido"));
	...
	public void atualizar() throws Exception {
		...
		ObjectMapper mapper = new ObjectMapper();
		String jsonString = mapper.writeValueAsString(estagioNegociacao);
		mockMvc.perform(put("/estagios/{id}", 1L).header("Authorization", "Bearer " + Util.getAccessToken("admin", "123321", mockMvc)).accept(MediaType.APPLICATION_JSON).content(jsonString).contentType(MediaType.APPLICATION_JSON))
				.andExpect(content().contentType(contentType)).andExpect(status().isCreated()).andDo(print()).andExpect(jsonPath("$.nome").value("nome")).andExpect(jsonPath("$.apelido").value("apelido"));
		verify(service, times(1)).atualizar(1L, estagioNegociacao);
	}
	...
	public void permissaoListar() throws Exception {
		...
		Pageable pageable = PageRequest.of(0, 10);
		when(service.filtrar(estagioNegociacaoFilterFilter, pageable)).thenReturn(page);
		mockMvc.perform(get("/estagios").header("Authorization", "Bearer " + Util.getAccessToken("user", "123321", mockMvc)).accept(MediaType.APPLICATION_JSON)).andExpect(status().isForbidden()).andDo(print());
		verify(service, times(0)).filtrar(estagioNegociacaoFilterFilter, pageable);
	}
	...
	public void permissaoListarsNome() throws Exception {
		...
		Pageable pageable = PageRequest.of(0, 10);
		when(service.filtrar(estagioNegociacaoFilterFilter, pageable)).thenReturn(page);
		mockMvc.perform(get("/estagios?nome=nome").header("Authorization", "Bearer " + Util.getAccessToken("user", "123321", mockMvc)).accept(MediaType.APPLICATION_JSON)).andExpect(status().isForbidden()).andDo(print());
		verify(service, times(0)).filtrar(estagioNegociacaoFilterFilter, pageable);
	}
	...
	public void permissaoListarCargo() throws Exception {
		...
		mockMvc.perform(get("/estagios?apelido=apelido").header("Authorization", "Bearer " + Util.getAccessToken("user", "123321", mockMvc)).accept(MediaType.APPLICATION_JSON)).andExpect(status().isForbidden()).andDo(print());
	...
	public void permissaoListarPosicao() throws Exception {
		...
		Pageable pageable = PageRequest.of(0, 10);
		when(service.filtrar(campanhaFilter, pageable)).thenReturn(page);
		mockMvc.perform(get("/estagios?posicao=1").header("Authorization", "Bearer " + Util.getAccessToken("user", "123321", mockMvc)).accept(MediaType.APPLICATION_JSON)).andExpect(status().isForbidden()).andDo(print());
		verify(service, times(0)).filtrar(campanhaFilter, pageable);
	}
	...
	public void permissaoBuscar() throws Exception {
		EstagioNegociacao estagioNegociacao = new EstagioNegociacao(1L, "nome", "apelido", 1, null);
		when(service.detalhar(3L)).thenReturn(estagioNegociacao);
		mockMvc.perform(get("/estagios/{id}", 3L).header("Authorization", "Bearer " + Util.getAccessToken("user", "123321", mockMvc)).accept(MediaType.APPLICATION_JSON)).andExpect(content().contentType(contentType))
	...
	public void permissaoDeletar() throws Exception {
		mockMvc.perform(delete("/estagios/{id}", 3L).header("Authorization", "Bearer " + Util.getAccessToken("user", "123321", mockMvc)).accept(MediaType.APPLICATION_JSON)).andExpect(status().isForbidden()).andDo(print());
	...
	public void permissaoCriar() throws Exception {
		...
		ObjectMapper mapper = new ObjectMapper();
		String jsonString = mapper.writeValueAsString(estagioNegociacao);
		mockMvc.perform(post("/estagios").header("Authorization", "Bearer " + Util.getAccessToken("user", "123321", mockMvc)).accept(MediaType.APPLICATION_JSON).content(jsonString).contentType(MediaType.APPLICATION_JSON))
	...
	public void permissaoAtualizar() throws Exception {
		...
		ObjectMapper mapper = new ObjectMapper();
		String jsonString = mapper.writeValueAsString(estagioNegociacao);
		mockMvc.perform(put("/estagios/{id}", 1L).header("Authorization", "Bearer " + Util.getAccessToken("user", "123321", mockMvc)).accept(MediaType.APPLICATION_JSON).content(jsonString).contentType(MediaType.APPLICATION_JSON))
				.andExpect(content().contentType(contentType)).andExpect(status().isForbidden()).andDo(print());
		verify(service, times(0)).atualizar(1L, estagioNegociacao);
	}
	...
	public void listamosTokenIncorreto() throws Exception {
		...
		Pageable pageable = PageRequest.of(0, 10);
		when(service.filtrar(estagioNegociacaoFilterFilter, pageable)).thenReturn(page);
		mockMvc.perform(get("/estagios").header("Authorization", "Bearer " + Util.getAccessToken("a", "a", mockMvc)).accept(MediaType.APPLICATION_JSON)).andExpect(content().contentType(contentType)).andExpect(status().isUnauthorized())
	...
	public void buscarTokenIncorreto() throws Exception {
		EstagioNegociacao estagioNegociacao = new EstagioNegociacao(1L, "nome", "posição", 1, null);
		when(service.detalhar(3L)).thenReturn(estagioNegociacao);
		mockMvc.perform(get("/estagios/{id}", 3L).header("Authorization", "Bearer " + Util.getAccessToken("a", "a", mockMvc)).accept(MediaType.APPLICATION_JSON)).andExpect(content().contentType(contentType))
	...
	public void deletarTokenIncorreto() throws Exception {
		...
		mockMvc.perform(delete("/estagios/1").header("Authorization", "Bearer " + Util.getAccessToken("a", "a", mockMvc)).accept(MediaType.APPLICATION_JSON)).andExpect(content().contentType(contentType)).andExpect(status().isUnauthorized())
				.andDo(print()).andExpect(jsonPath("$.error").value("invalid_token"));
	...
	public void criarTokenIncorreto() throws Exception {
		...
		ObjectMapper mapper = new ObjectMapper();
		String jsonString = mapper.writeValueAsString(estagioNegociacao);
		mockMvc.perform(post("/estagios").header("Authorization", "Bearer " + Util.getAccessToken("a", "a", mockMvc)).accept(MediaType.APPLICATION_JSON).content(jsonString).contentType(MediaType.APPLICATION_JSON))
	...
	public void atualizarTokenIncorreto() throws Exception {
		...
		ObjectMapper mapper = new ObjectMapper();
		String jsonString = mapper.writeValueAsString(estagioNegociacao);
		mockMvc.perform(put("/estagios/1").header("Authorization", "Bearer " + Util.getAccessToken("a", "a", mockMvc)).accept(MediaType.APPLICATION_JSON).content(jsonString).contentType(MediaType.APPLICATION_JSON))
				.andExpect(content().contentType(contentType)).andExpect(status().isUnauthorized()).andDo(print()).andExpect(jsonPath("$.error").value("invalid_token"));
		verify(service, times(0)).atualizar(1L, estagioNegociacao);
	}
	...
	public void listamosSemToken() throws Exception {
		...
		Pageable pageable = PageRequest.of(0, 10);
		when(service.filtrar(estagioNegociacaoFilterFilter, pageable)).thenReturn(page);
		mockMvc.perform(get("/estagios")).andExpect(content().contentType(contentType)).andExpect(status().isUnauthorized()).andDo(print()).andExpect(jsonPath("$.error").value("unauthorized"));
		verify(service, times(0)).filtrar(estagioNegociacaoFilterFilter, pageable);
	}
	...
	public void buscarSemToken() throws Exception {
		EstagioNegociacao estagioNegociacao = new EstagioNegociacao(1L, "nome", "posição", 1, null);
		when(service.detalhar(3L)).thenReturn(estagioNegociacao);
		mockMvc.perform(get("/estagios/{id}", 3L)).andExpect(content().contentType(contentType)).andExpect(status().isUnauthorized()).andDo(print()).andExpect(jsonPath("$.error").value("unauthorized"));
		verify(service, times(0)).detalhar(3L);
	}
	...
	public void deletarSemToken() throws Exception {
		when(service.deletar(3L)).thenReturn(estagioNegociacao);
		mockMvc.perform(delete("/estagios/1")).andExpect(content().contentType(contentType)).andExpect(status().isUnauthorized()).andDo(print()).andExpect(jsonPath("$.error").value("unauthorized"));
		verify(service, times(0)).deletar(1L);
	}
	...
	public void criarSemToken() throws Exception {
		...
		ObjectMapper mapper = new ObjectMapper();
		String jsonString = mapper.writeValueAsString(estagioNegociacao);
		mockMvc.perform(post("/estagios").accept(MediaType.APPLICATION_JSON).content(jsonString).contentType(MediaType.APPLICATION_JSON)).andExpect(content().contentType(contentType)).andExpect(status().isUnauthorized()).andDo(print())
	...
	public void atualizarSemToken() throws Exception {
		...
		ObjectMapper mapper = new ObjectMapper();
		String jsonString = mapper.writeValueAsString(estagioNegociacao);
		mockMvc.perform(put("/estagios/1").accept(MediaType.APPLICATION_JSON).content(jsonString).contentType(MediaType.APPLICATION_JSON)).andExpect(content().contentType(contentType)).andExpect(status().isUnauthorized()).andDo(print())
				.andExpect(jsonPath("$.error").value("unauthorized"));
		verify(service, times(0)).atualizar(1L, estagioNegociacao);
	}
	...
	public void criarNomeNull() throws Exception {
		...
		mockMvc.perform(post("/estagios").header("Authorization", "Bearer " + Util.getAccessToken("admin", "123321", mockMvc)).accept(MediaType.APPLICATION_JSON).content(jsonString).contentType(MediaType.APPLICATION_JSON))
				...
				.andExpect(jsonPath("$.fieldMessage").value("O nome não pode ser null")).andExpect(jsonPath("$.field").value("nome"));
		verify(service, times(0)).salvar(estagioNegociacao);
	}

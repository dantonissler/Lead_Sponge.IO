...
import com.leadsponge.IO.repository.Filter.*;
...
import com.leadsponge.IO.services.*;
...
class LeadSpongeTestes {
    ...
    class CampanhaTestes {
        ...
        class TokenValido {
            ...
            private final Campanha campanha = new Campanha(3L, "nome", "descrição");
        ...
        class ValidacoesEntidade {
            ...
            private final Campanha nomeNull = new Campanha(null, null, "descrição");
            private final Campanha nomeVazio = new Campanha(null, "", "descrição");
            private final Campanha nomeMaior50 = new Campanha(null, "Nome campanha, nome campanha, nome campanha e nomes", "campanha descricao");
            private final Campanha nomeMenor4 = new Campanha(1L, "Nom", "campanha descrição");
            private ObjectMapper mapper;
            ...
            public void criarNomeVazio() throws Exception {
                when(service.salvar(Mockito.any(Campanha.class))).thenReturn(nomeVazio);
            ...
            public void criarNomeNull() throws Exception {
                when(service.salvar(Mockito.any(Campanha.class))).thenReturn(nomeNull);
            ...
            public void criarNomeAcima50Caracteres() throws Exception {
                when(service.salvar(Mockito.any(Campanha.class))).thenReturn(nomeMaior50);
            ...
            public void criarNomeAbaixo4Caracteres() throws Exception {
                when(service.salvar(Mockito.any(Campanha.class))).thenReturn(nomeMenor4);
...
//			Arrays.asList(Mockito.any(Segmento.class)), Arrays.asList(Mockito.any(Usuario.class)), Mockito.any(Usuario.class))));
    ...
    class MotivoPerdaTestes {
        ...
        class TokenInvalido {
            ...
            private final Pageable pageable = PageRequest.of(0, 10);
            private final MotivoPerdaFilter filter = new MotivoPerdaFilter();
            private final MotivoPerda motivoPerda = new MotivoPerda(1L, "nome", null);
        ...
        class SemPermissao {
            ...
            private final Pageable pageable = PageRequest.of(0, 10);
            private final MotivoPerdaFilter filter = new MotivoPerdaFilter();
            private final MotivoPerdaFilter filterNome = new MotivoPerdaFilter("nome");
            private final MotivoPerda motivoPerda = new MotivoPerda(1L, "nome", null);

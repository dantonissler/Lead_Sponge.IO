...
public abstract class NegociacaoProduto_ {
	...
	public static volatile SingularAttribute<NegociacaoProduto, Produto> produtoNegociacaoProduto;
	public static volatile SingularAttribute<NegociacaoProduto, Negociacao> negociacaoProdutoNegociacao;
	public static final String ID = "id";
	public static final String QUANTIDADE_PRODUTOS = "quantidadeProdutos";
	public static final String PRODUTO = "produtoNegociacaoProduto";
	public static final String NEGOCIACAO = "negociacaoProdutoNegociacao";
}

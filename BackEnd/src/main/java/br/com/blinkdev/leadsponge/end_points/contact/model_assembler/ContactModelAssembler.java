package br.com.blinkdev.leadsponge.end_points.contact.model_assembler;
...
@Component
public class ContactModelAssembler extends RepresentationModelAssemblerSupport<ContactEntity, ContactModel> {
    @Autowired

package br.com.blinkdev.leadsponge.endPoints.negociacaoProduto.controller;
...
class NegociacaoProdutoController {
    ...
    public Page<NegociacaoProdutoEntity> list(NegociacaoProdutoFilter negociacaoProdutoFilter, Pageable pageable) {
    ...
    ResponseEntity<NegociacaoProdutoEntity> cadastrar(@Valid @RequestBody NegociacaoProdutoEntity nProduto, HttpServletResponse response) {
        NegociacaoProdutoEntity criarNP = negociacaoProdutoService.salvar(nProduto);
    ...
    ResponseEntity<NegociacaoProdutoEntity> atualizar(@Valid @RequestBody NegociacaoProdutoEntity nProduto, @PathVariable Long id, HttpServletResponse response) {
        NegociacaoProdutoEntity novoNegociacaoProduto = negociacaoProdutoService.atualizar(id, nProduto);
    ...
    @GetMapping(value = {"/{id}"})
    @PreAuthorize("hasAuthority('PESQUISAR_CAMPANHA') and #oauth2.hasScope('read')")
    ResponseEntity<NegociacaoProdutoEntity> detalhar(@Valid @PathVariable("id") Long id) {
    ...
    ResponseEntity<NegociacaoProdutoEntity> remover(@PathVariable Long id) {

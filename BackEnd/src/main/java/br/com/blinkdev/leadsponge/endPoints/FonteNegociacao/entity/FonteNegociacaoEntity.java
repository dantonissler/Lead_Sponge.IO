...
public class FonteNegociacaoEntity extends UserDateAudit implements Serializable {
    ...
    public FonteNegociacaoEntity(@Size(min = 4, max = 50) String nome) {
        super();
        this.nome = nome;
    }
    ...
    public boolean equals(Object o) {
        ...
        FonteNegociacaoEntity that = (FonteNegociacaoEntity) o;

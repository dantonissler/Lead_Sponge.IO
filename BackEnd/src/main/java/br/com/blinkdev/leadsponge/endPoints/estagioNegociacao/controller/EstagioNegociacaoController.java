package br.com.blinkdev.leadsponge.endPoints.estagioNegociacao.controller;
...
class EstagioNegociacaoController {
    ...
    Page<EstagioNegociacaoEntity> list(EstagioNegociacaoFilter estagioNegociacaoFilter, Pageable pageable) {
    ...
    ResponseEntity<EstagioNegociacaoEntity> cadastrar(@Valid @RequestBody EstagioNegociacaoEntity estagioNegociacao, HttpServletResponse response) {
        EstagioNegociacaoEntity criarEstagioNegociacao = estagioNegociacaoService.salvar(estagioNegociacao);
    ...
    @PutMapping(value = {"/{id}"})
    @PreAuthorize("hasAuthority('CADASTRAR_ESTAGIO') and #oauth2.hasScope('write')")
    ResponseEntity<EstagioNegociacaoEntity> atualizar(@Valid @RequestBody EstagioNegociacaoEntity estagioNegociacao, @PathVariable Long id, HttpServletResponse response) {
        EstagioNegociacaoEntity novaEstagioNegociacao = estagioNegociacaoService.atualizar(id, estagioNegociacao);
    ...
    ResponseEntity<EstagioNegociacaoEntity> deletar(@PathVariable Long id) {
        return ResponseEntity.ok(estagioNegociacaoService.deletar(id));
    }

    @GetMapping(value = {"/{id}"})
    @PreAuthorize("hasAuthority('PESQUISAR_ESTAGIO') and #oauth2.hasScope('read')")
    public ResponseEntity<EstagioNegociacaoEntity> detalhar(@Valid @PathVariable("id") Long id) {
